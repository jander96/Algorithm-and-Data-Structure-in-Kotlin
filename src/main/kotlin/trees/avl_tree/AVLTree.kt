...
class AVLTree<T : Comparable<T>> {
    ...
    private fun insert(node: AVLNode<T>?, value: T): AVLNode<T> {
        ...
        balancedNode.height = max(balancedNode.lefHeight , balancedNode.rightHeight ) +1
    ...
    private fun leftRotate(node: AVLNode<T>): AVLNode<T>{
        ...
        node.height = max(node.lefHeight, node.rightHeight) +1
        pivot.height = max(pivot.lefHeight, pivot.rightHeight) +1
        return pivot
    }
